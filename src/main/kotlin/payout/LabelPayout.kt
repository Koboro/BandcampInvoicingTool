 ...
 *
 * The amount taken by a sale is determined in the [Contract].
 * If the [Contract.labelPercentageBeforeBreakEven] and [Contract.labelPercentageAfterBreakEven] are different then
